...
public final class UsersGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs,
      tukano.impl.grpc.generated_java.UsersProtoBuf.Void> getFindUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "findUser",
      requestType = tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs.class,
      responseType = tukano.impl.grpc.generated_java.UsersProtoBuf.Void.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs,
      tukano.impl.grpc.generated_java.UsersProtoBuf.Void> getFindUserMethod() {
    io.grpc.MethodDescriptor<tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs, tukano.impl.grpc.generated_java.UsersProtoBuf.Void> getFindUserMethod;
    if ((getFindUserMethod = UsersGrpc.getFindUserMethod) == null) {
      synchronized (UsersGrpc.class) {
        if ((getFindUserMethod = UsersGrpc.getFindUserMethod) == null) {
          UsersGrpc.getFindUserMethod = getFindUserMethod =
              io.grpc.MethodDescriptor.<tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs, tukano.impl.grpc.generated_java.UsersProtoBuf.Void>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "findUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  tukano.impl.grpc.generated_java.UsersProtoBuf.Void.getDefaultInstance()))
              .setSchemaDescriptor(new UsersMethodDescriptorSupplier("findUser"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void findUser(tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs request,
        io.grpc.stub.StreamObserver<tukano.impl.grpc.generated_java.UsersProtoBuf.Void> responseObserver) {
  ...
  public static final class UsersStub
    ...
    /**
     */
    public void findUser(tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs request,
        io.grpc.stub.StreamObserver<tukano.impl.grpc.generated_java.UsersProtoBuf.Void> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class UsersBlockingStub
    ...
    /**
     */
    public tukano.impl.grpc.generated_java.UsersProtoBuf.Void findUser(tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class UsersFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<tukano.impl.grpc.generated_java.UsersProtoBuf.Void> findUser(
        tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_FIND_USER = 5;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_FIND_USER:
          serviceImpl.findUser((tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs) request,
              (io.grpc.stub.StreamObserver<tukano.impl.grpc.generated_java.UsersProtoBuf.Void>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              tukano.impl.grpc.generated_java.UsersProtoBuf.FindUserArgs,
              tukano.impl.grpc.generated_java.UsersProtoBuf.Void>(
